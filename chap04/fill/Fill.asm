...
(LOOP)      //progresses the index backwards. NOTE: repeat が充分長いことが前提
	@i
	M=M-1
	D=M
	@INIT
...
(BLACK)
	...
	M=-1    //sets value in current address to -1, so that the whole word will be 1...1 (16bits long),  meaning - all 16 pixels will be "painted" black.
